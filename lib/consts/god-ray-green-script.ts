export const godRayScript = `// Fragment shader
...
use: <float|vec3 ec4> srgb2rgb(<float|vec3|vec4> srgb)
*/
...
use: <float|vec3 ec4> rgb2srgb(<float|vec3|vec4> srgb)
*/
...
use: <vec3 ec4> mixOklab(<vec3|vec4> colorA, <vec3|vec4> colorB, float pct)
options:
...
vec4 rays1 =
vec4(0.,0.,0., .0) +
rayStrength(rayPos1, rayRefDir1, coord, raySeedA1, raySeedB1, raySpeed1) * u_color;

vec4 rays2 =
vec4(0.,0.,0., .0) +
rayStrength(rayPos2, rayRefDir2, coord, raySeedA2, raySeedB2, raySpeed2) * u_alternate;
