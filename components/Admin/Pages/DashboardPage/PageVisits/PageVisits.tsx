...
const PageVisits = () => {
  const { displayVisitsCount } = useDashboard()
  ...
  return (
    ...
    >
      <div className="flex !h-[48px] items-center rounded-l-full rounded-tr-full bg-gray_overlay_6 px-[24px]">
        <p className="font-urwgeometric_bold text-[16px] text-gray_1">Booking Page Visits</p>
      </div>
      <div
        className="flex h-[calc(220px-48px)] flex-col overflow-y-auto
              overflow-x-hidden py-[10px] pl-[22px]"
      >
